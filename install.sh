...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/kalamvpn/vpn_v1/main/"
...
TIMES=30
    ...
    local USRSC=$(wget -qO- https://raw.githubusercontent.com/kalamvpn/izin_ip/main/izin_ip | grep "$ipsaya" | awk '{print $2}' | head -n 1)
    local EXPSC=$(wget -qO- https://raw.githubusercontent.com/kalamvpn/izin_ip/main/izin_ip | grep "$ipsaya" | awk '{print $3}' | head -n 1)
    if [[ -z "$passwd" ]]; then
